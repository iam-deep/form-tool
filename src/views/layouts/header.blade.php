...
<head>
  ...
  <title>@if (isset($title)) {{ $title }} @endif | Admin</title>
  ...
  <link rel="stylesheet" href="{{ URL::asset('/assets/vendor/form-tool/dist/css/skins/skin-blue.min.css') }}">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="{{ URL::asset('assets/vendor/form-tool/dist/img/avatar.png') }}" class="img-circle" alt="User Image">
